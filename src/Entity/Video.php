...
class Video
{
    ...
    private function facebookId($url)
    {
    ...
    public function extractIdentif()
    {
        ...
        else if (preg_match("#^(http|https)://www.facebook.com/#", $url))  // Si c’est une url facebook on execute la fonction correspondante
        {
            $this->facebookId($url);
        }
    ...
    private  function url()
    {
        ...
        else if ($control == 'favebook')
        {
            $embed = "https://www.facebook.com/embed/video/".$id;
            return $embed;
        }
    ...
    public function image()
    {
        ...
        {
            $image = 'https://www.dailymotion.com/embed/150x120/videos/'. $id. '' ;
            return $image;
        }
        else if ($control == 'dailymotion')
        {
